...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      ref={containerRef}
      className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 bg-background relative overflow-hidden pt-28 pb-20 sm:pt-32 sm:pb-28"
    >
      {/* Background elements */}
      <div
        ref={gridRef}
      ...
      <div className="w-full max-w-7xl mx-auto z-10 flex flex-col items-center text-center space-y-9 sm:space-y-12">
        {/* Status Badge */}
        <div className="hero-badge group flex items-center gap-3 px-5 py-2.5 dev-border rounded-full shadow-lg dark:shadow-[0_0_20px_rgba(0,0,0,0.3)] cursor-default overflow-hidden relative max-w-[calc(100vw-2rem)]">
          ...
          <span className="text-[10px] sm:text-xs font-mono font-bold tracking-[0.18em] sm:tracking-[0.2em] uppercase text-primary/80 relative z-10 leading-relaxed">
            {t.hero.status}
          </span>
        </div>
        ...
        <div className="relative space-y-5 perspective-2000">
          ...
          <h1
            className="flex flex-wrap justify-center py-3 gap-x-[0.26em] preserve-3d"
            aria-label={name}
          >
            {name.split(" ").map((word, i) => (
              <span
                key={i}
                className="inline-block whitespace-nowrap preserve-3d"
                aria-hidden="true"
              >
          ...
          <h2 className="hero-description text-lg sm:text-2xl md:text-3xl text-muted-foreground font-medium tracking-tight max-w-4xl text-balance leading-relaxed sm:leading-snug">
            {t.hero.description}
          </h2>
        </div>
        ...
        <div className="hero-description flex flex-wrap items-center justify-center gap-5 pt-4 sm:pt-8 text-muted-foreground/60">
          <a
