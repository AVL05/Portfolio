...
const copy = {
  es: {
    ...
    kicker: "Caso de estudio / Archivo visual editorial",
    lead: "Un archivo fotográfico construido para que 30 imágenes funcionen como un recorrido: narrativa, series, movimiento y exploración accesible en español e inglés.",
    ...
    role: "Mi papel",
    roleText: "Dirección de producto y visual, arquitectura frontend, modelado de contenido, curación, motion, accesibilidad, SEO localizado, tests y entrega continua.",
    stack: "Stack verificado",
    direction: "Dirección visual, curación y movimiento",
  ...
  en: {
    ...
    kicker: "Case study / Editorial visual archive",
    lead: "A photography archive built so 30 images work as a journey: narrative, series, motion, and accessible exploration in Spanish and English.",
    ...
    role: "My role",
    roleText: "Product and visual direction, frontend architecture, content modelling, curation, motion, accessibility, localized SEO, tests, and continuous delivery.",
    stack: "Verified stack",
    direction: "Visual direction, curation, and motion",
    ...
    <main id="main-content" className="case-study min-h-screen overflow-hidden bg-background text-foreground">
      <section className="relative px-4 pb-16 pt-6 sm:px-6 lg:px-8">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <nav aria-label={t.back} className="mb-12 flex items-center justify-between rounded-xl border border-border/65 bg-card/60 px-4 py-3 backdrop-blur-xl sm:mb-16">
            ...
            <a href={productionUrl} target="_blank" rel="noopener noreferrer" className="inline-flex min-h-11 items-center gap-2 rounded-lg border border-border/70 px-4 py-2 font-mono text-[10px] font-black uppercase tracking-[0.16em] transition-colors hover:border-primary/45 hover:text-primary">raw.vives <ExternalLink className="h-3.5 w-3.5" /></a>
          </nav>
